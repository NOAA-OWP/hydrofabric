...
- [Download](https://cran.r-project.org/bin/windows/base/) the latest R installer (.exe) for Windows. Install the downloaded file as any other windows app. Now that R is installed, you can download and install RStudio.
