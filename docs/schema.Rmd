...
Nexus locations define that locations where information (model states, ect) can be exchanged. They are fundemental to the Nextgen topology and model engine design.
