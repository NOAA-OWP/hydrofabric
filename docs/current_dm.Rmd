...
- [ ] *Change*:
    - [ ] `ELEVATION`  --> `wb_elevation`
    - [ ] `MeanDepth`  --> `wb_mean_depth`
    - [ ] `LakeVolume` --> `wb_lake_volume`
    - [ ] `MaxDepth`   --> `wb_max_depth`
...
- [ ] Change table name from to `mapped_POIs`
- [ ]  Change all names to lower case
